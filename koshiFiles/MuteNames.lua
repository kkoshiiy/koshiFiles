...
if DevAbs:get(koshi.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(koshi.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(koshi.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(koshi.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(koshi.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(koshi.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
koshiName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if koshiName then 
koshiNames = DevAbs:smembers(koshi.."Abs:Mute:Names"..msg.chat_id_) or ""
if koshiNames and koshiNames[1] then 
for i=1,#koshiNames do 
if koshiName:match("(.*)("..koshiNames[i]..")(.*)") then 
...
DevAbs:set(koshi.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(koshi.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
